  ...
  return (
    <>
      <div className="flex flex-row w-full">
        <div className="w-full flex flex-col items-start self-stretch gap-[28px] p-[35px] rounded-[42px] border border-black/5 bg-white shadow-[0_2px_12px_0_rgba(0,0,0,0.03)]">
          <div className="w-full flex flex-row gap-[11px]">
            <CalendarIcon className=" text-[#3BB2F6] bg-[#EFF6FF]" />
            <h1 className="w-full font-['Inter'] text-[17px] font-[900]  text-[#1A1A1C] rounded-2xl">
              다음 배송일 조정
            </h1>
          </div>
