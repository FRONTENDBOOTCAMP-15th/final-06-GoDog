...
export default async function Home() {
  ...
  if (!bestProductsRes.ok) {
    return <div role="alert" aria-live="assertive">{bestProductsRes.message}</div>;
  }
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-30">
            <div>
              ...
              <div className="flex flex-col items-center lg:items-start gap-10 -mt-6">
                <FeatureItem
                  icon={<img src="/icons/chart-box-orange.svg" alt="차트 아이콘" className="w-14.5 h-14.5" />}
                  title="실시간 영양 최적화"
                  description="우리는 모든 반려견이 건강하고 행복한 삶을 살 수 있도록, 최고 품질의 사료와 과학적인 영양배합으로 사료를 제공합니다."
                />
                <FeatureItem
                  icon={<img src="/icons/verify-box-orange.svg" alt="검증 아이콘" className="w-14.5 h-14.5" />}
                  title="맞춤 영양 솔루션"
...
맞는 맞춤형 영양 솔루션을 개발했습니다."
                ...
                <FeatureItem
                  icon={<img src="/icons/qr-box-orange.svg" alt="QR 아이콘" className="w-14.5 h-14.5" />}
                  title="신선한 원재료"
